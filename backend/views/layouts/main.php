                    ...
                    <ul class="page-sidebar-menu " data-keep-expanded="false" data-auto-scroll="true"
                        ...
                        <li id="li_1" class="start">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li>
                                    <a href="index_2.html"><i class="icon-bulb"></i>New Dashboard #1</a>
                                </li>
                                <li>
                                    <a href="index_3.html"><i class="icon-graph"></i>New Dashboard #2</a>
                                </li>
                            </ul>
                        </li>
                        <li id="li_2">
                            ...
                            <ul class="sub-menu">
                                <li>
                                    <a href="index.php?r=ecommerce/index"><i class="icon-home"></i>Dashboard</a>
                                </li>
                                <li>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li>
                                    <a href="ui_alert_dialog_api.html">
                                        <span class="badge badge-roundless badge-danger">new</span>Alerts & Dialogs API
                                    </a>
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu">
                                <li>
                                    <a href="components_pickers.html">Date & Time Pickers</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="components_form_tools2.html">Form Widgets & Tools 2</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="components_jqueryui_sliders.html">jQuery UI Sliders</a>
                                </li>
                                <li>
                            ...
                            <ul class="sub-menu">
                                <li>
                                    <a href="form_controls_md.html">
                                        ...
                                        Material Design<br>Form Controls
                                    </a>
                                </li>
                                <li>
                                    <a href="form_controls.html">Bootstrap<br>Form Controls</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="form_editable.html">
                                        <span class="badge badge-roundless badge-warning">new</span>Form X-editable
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="form_image_crop.html">
                                        <span class="badge badge-roundless badge-danger">new</span>Image Cropping
                                    </a>
                                </li>
                                <li>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li>
                                    <a href="portlet_general2.html">
                                        <span class="badge badge-roundless badge-danger">new</span>New Portlets #1
                                    </a>
                                </li>
                                <li>
                                    <a href="portlet_general3.html">
                                        <span class="badge badge-roundless badge-danger">new</span>New Portlets #2
                                    </a>
                                </li>
                                <li>
                            ...
                            <ul class="sub-menu">
                                <li>
                                    <a href="page_timeline.html">
                                        <i class="icon-paper-plane"></i>
                                        <span class="badge badge-warning">2</span>New Timeline
                                    </a>
                                </li>
                                <li>
                                    <a href="extra_profile.html">
                                        <i class="icon-user-following"></i>
                                        <span class="badge badge-success badge-roundless">new</span>New User Profile
                                    </a>
                                </li>
                                <li>
                                    <a href="page_todo.html">
                                ...
                                <li>
                                    <a href="page_coming_soon.html"><i class="icon-flag"></i>Coming Soon</a>
                                </li>
                                <li>
                                    <a href="page_blog.html"><i class="icon-speech"></i>Blog</a>
                                </li>
                                <li>
                                    <a href="page_blog_item.html"><i class="icon-link"></i>Blog Post</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="page_timeline_old.html">
                                        <i class="icon-paper-plane"></i>
                                        <span class="badge badge-warning">2</span>Old Timeline
                                    </a>
                                </li>
                                <li>
                                    <a href="extra_profile_old.html"><i class="icon-user"></i>Old User Profile</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li>
                                    <a href="quick_sidebar_over_content_transparent.html">Over Content & Transparent</a>
                                </li>
                                <li>
                                    <a href="quick_sidebar_on_boxed_layout.html">Boxed Layout</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="sub-menu">
                                <li>
                                    <a href="email_template1/index.html">New Email Template 1</a>
                                </li>
                                <li>
                                    <a href="email_template2/index.html">New Email Template 2</a>
                                </li>
                                <li>
                                    <a href="email_template3/index.html">New Email Template 3</a>
                                </li>
                                <li>
                                    <a href="email_template4/index.html">New Email Template 4</a>
                                </li>
                                <li>
                        ...
                        <ul class="nav nav-tabs nav-justified">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu pull-right" role="menu">
                                    <li>
                                        <a href="#quick_sidebar_tab_3" data-toggle="tab"><i class="icon-bell"></i>
                                            Alerts </a>
                                    </li>
                                    <li>
                                        <a href="#quick_sidebar_tab_3" data-toggle="tab"><i class="icon-info"></i>
                                            Notifications
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#quick_sidebar_tab_3" data-toggle="tab"><i class="icon-speech"></i>
                                            Activities
                                        </a>
                                    </li>
                                    <li class="divider"></li>
                                    <li>
                                        <a href="#quick_sidebar_tab_3" data-toggle="tab"><i class="icon-settings"></i>
                                            Settings
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <div class="tab-pane active page-quick-sidebar-chat" id="quick_sidebar_tab_1">
                                <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd"
                                    ...
                                    <ul class="media-list list-items">
                                        ...
                                        <li class="media">
                                            <div class="media-status">
                                                <span class="badge badge-success">7</span></div>
                                        ...
                                        <li>
                                            <div class="col1">
                                                <div class="cont">
                                                    ...
                                                    <span class="label label-sm label-warning">Take action <i
                                            ...
                                            <a href="javascript:;">
                                                <div class="col1">
                                                    <div class="cont">
                                                        ...
                                                        <div class="cont-col2">
                                                            <div class="desc">
                                                                IPO Report for year 2013 has been eleased.
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
