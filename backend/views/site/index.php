                        ...
                        <div class="actions">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li>
                                        <a href="javascript:;">
                                            Q1 2014 <span class="label label-sm label-default"> past </span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:;">
                                            Q2 2014 <span class="label label-sm label-default"> past </span>
                                        </a>
                                    </li>
                                    <li class="active">
                                        <a href="javascript:;">
                                            Q3 2014 <span class="label label-sm label-success"> current </span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:;">
                                            Q4 2014 <span class="label label-sm label-warning"> upcoming </span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="actions">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    ...
                                    <li>
                                        <a href="javascript:;"> Completed <span
                            ...
                            <div class="scroller" style="height: 305px;" data-always-visible="1"
                                ...
                                <ul class="task-list">
                                    <li>
                                        ...
                                        <div class="task-config">
                                            <div class="task-config-btn btn-group">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    <li>
                                                        <a href="javascript:;"><i class="fa fa-check"></i> Complete
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:;"><i class="fa fa-pencil"></i> Edit
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:;"><i class="fa fa-trash-o"></i> Cancel
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="task-title">
                                            <span
                                                class="task-title-sp">AirAsia Intranet System Project Internal Meeting </span>
                                    ...
                                    <li>
                                        ...
                                        <div class="task-title">
                                                <span
                                                    class="task-title-sp">Kick-off Company CRM Mobile App Development </span>
                                    ...
                                    <li>
                                        ...
                                        <div class="task-title">
                                            <span
                                                class="task-title-sp">Sign-Off The Comercial Agreement With AutoSmart </span>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="easy-pie-chart">
                                    ...
                                    <a class="title" href="javascript:;">Transactions <i
                            ...
                            <div class="col-md-4">
                                <div class="easy-pie-chart">
                                    ...
                                    <a class="title" href="javascript:;"> New Visits <i
                                            class="icon-arrow-right"></i></a>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="easy-pie-chart">
                                    ...
                                    <a class="title" href="javascript:;"> Bounce <i
                                            class="icon-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="sparkline-chart">
                                    ...
                                    <a class="title" href="javascript:;"> Network <i
                                            class="icon-arrow-right"></i></a>
                                </div>
                            </div>
                            <div class="margin-bottom-10 visible-sm"></div>
                            <div class="col-md-4">
                                <div class="sparkline-chart">
                                    ...
                                    <a class="title" href="javascript:;">CPU Load <i
                                            class="icon-arrow-right"></i></a>
                                </div>
                            </div>
                            <div class="margin-bottom-10 visible-sm"></div>
                            <div class="col-md-4">
                                <div class="sparkline-chart">
                                    ...
                                    <a class="title" href="javascript:;"> Load Rate <i class="icon-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="scroller" style="height: 290px;" data-always-visible="1"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 user-info">
                                            ...
                                            <div class="details">
                                                <div>
                                                    <a href="javascript:;"> Robert Nilson </a>
                                                        <span
                                                            class="label label-sm label-success label-mini"> Approved </span>
                                                </div>
                                        ...
                                        <div class="col-md-6 user-info">
                                            ...
                                            <div class="details">
                                                <div>
                                                    <a href="javascript:;"> Lisa Miller </a>
